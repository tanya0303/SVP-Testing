...
export default function ManageMeasuresModal({
  ...
  const measures = [
    { subsets: ['SalesAgreement', 'Revenue', 'Q1 Sales', 'Annual'], name: 'Sales Agreement Quantity', description: 'Total contracted quantity from sales agreements.', unit: 'volume', dataType: 'Number', aggregation: 'Sum', sourceName: 'SalesAgreement', selected: false },
    { subsets: ['Baseline', 'Forecast', 'Actuals'], name: 'Baseline Volume', description: 'Baseline sales volume used for plan comparison.', unit: 'volume', dataType: 'Number', aggregation: 'Sum', sourceName: 'OpportunityLineItem', selected: false },
    { subsets: ['Promotions', 'Marketing', 'Campaigns'], name: 'Promotional Lift', description: 'Incremental volume generated by promotions.', unit: 'volume', dataType: 'Number', aggregation: 'Sum', sourceName: 'Trade Promotion', selected: false },
    { subsets: ['Trade', 'ROI', 'Performance', 'Analytics'], name: 'Trade ROI', description: 'Average return on trade promotion investments.', unit: '%', dataType: 'Percent', aggregation: 'Average', sourceName: 'Trade Promotion', selected: false },
    { subsets: ['Revenue', 'Sales', 'Net Value'], name: 'Net Sales Value (NSV)', description: 'Net revenue after discounts and adjustments.', unit: 'currency', dataType: 'Currency', aggregation: 'Sum', sourceName: 'OpportunityLineItem', selected: false },
    { subsets: ['Budget', 'Finance', 'Planning'], name: 'Remaining Budget', description: 'Available budget balance for the planning period.', unit: 'currency', dataType: 'Currency', aggregation: 'Sum', sourceName: 'Account Budget', selected: false },
    { subsets: ['Fund', 'Allocation', 'Budget', 'Trade'], name: 'Fund Allocation', description: 'Allocated funds across promotions and accounts.', unit: 'currency', dataType: 'Currency', aggregation: 'Sum', sourceName: 'Trade Promotion', selected: false },
    { subsets: ['Deductions', 'Adjustments'], name: 'Deduction Amount', description: 'Total deduction amount applied to sales.', unit: 'currency', dataType: 'Currency', aggregation: 'Sum', sourceName: 'Deduction', selected: false },
    { subsets: ['Forecast', 'Pipeline', 'Future'], name: 'Forecasted Quantity', description: 'Projected quantity based on current forecast.', unit: 'volume', dataType: 'Number', aggregation: 'Sum', sourceName: 'Opportunity', selected: false },
    { subsets: ['Pipeline', 'Opportunities', 'Weighted'], name: 'Weighted Pipeline', description: 'Pipeline value weighted by probability to close.', unit: 'currency', dataType: 'Currency', aggregation: 'Sum', sourceName: 'Opportunity', selected: false },
    { subsets: ['Quota', 'Goals', 'Targets', 'Attainment'], name: 'Quota Attainment %', description: 'Percentage of quota achieved by teams.', unit: '%', dataType: 'Percent', aggregation: 'Average', sourceName: 'Territory', selected: false },
    { subsets: ['Performance', 'Win Rate', 'Success'], name: 'Win Rate', description: 'Rate of won opportunities versus total opportunities.', unit: '%', dataType: 'Percent', aggregation: 'Average', sourceName: 'Opportunity', selected: false },
    { subsets: ['Performance', 'Metrics', 'KPI'], name: 'Performance', description: 'Composite performance score across KPIs.', unit: 'score', dataType: 'Number', aggregation: 'Average', sourceName: 'Goal', selected: false },
  ];
