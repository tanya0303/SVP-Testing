...
export default function HeroContainer({
  title = 'Commercial Planning and Forecasting',
  description = 'Run, update and manage forecast with live rollup, visual signals, AI predictions and historical trends'
}) {
  return (
